package models.xml.nfeproc.nfe.infnfe.retirada;
...
@XmlRootElement(name = TagXml.RETIRADA, namespace = TagXml.NAMESPACE)
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = TagXml.RETIRADA, namespace = TagXml.NAMESPACE)
